		...
		if (ImGui::TreeNode("Cabin"))
		{
			if (ImGui::TreeNode("CabinPosition"))
			{
				for (int i = 0; i < CabinData_.size(); i++)
				{
					...
					ImGui::InputFloat((labelX.c_str()), &CabinData_[i].position_.x);

					std::string labelY = "CabinPositionY_" + std::to_string(i);
					ImGui::InputFloat((labelY.c_str()), &CabinData_[i].position_.y);

					std::string labelZ = "CabinPositionZ_" + std::to_string(i);
					ImGui::InputFloat((labelZ.c_str()), &CabinData_[i].position_.z);
				}
				ImGui::TreePop();
			}
			...
			if (ImGui::TreeNode("CabinRotate"))
			{
				for (int i = 0; i < CabinData_.size(); i++)
				{
					...
					ImGui::InputFloat((labelX.c_str()), &CabinData_[i].rotate_.x);

					std::string labelY = "CabiRotateY_" + std::to_string(i);
					ImGui::InputFloat((labelY.c_str()), &CabinData_[i].rotate_.y);

					std::string labelZ = "CabinRotateZ_" + std::to_string(i);
					ImGui::InputFloat((labelZ.c_str()), &CabinData_[i].rotate_.z);
				}
				ImGui::TreePop();
			}
			...
			if (ImGui::TreeNode("CabinScale"))
			{
				for (int i = 0; i < CabinData_.size(); i++)
				{
					...
					ImGui::InputFloat((labelX.c_str()), &CabinData_[i].scale_.x);

					std::string labelY = "CabiScaleY_" + std::to_string(i);
					ImGui::InputFloat((labelY.c_str()), &CabinData_[i].scale_.y);

					std::string labelZ = "CabinScaleZ_" + std::to_string(i);
					ImGui::InputFloat((labelZ.c_str()), &CabinData_[i].scale_.z);
				}
				ImGui::TreePop();
			}
		...
		if (ImGui::TreeNode("Tree"))
		{
			if (ImGui::TreeNode("TreePosition"))
			{
				for (int i = 0; i < TreeData_.size(); i++)
				{
					...
					ImGui::InputFloat((labelX.c_str()), &TreeData_[i].position_.x);

					std::string labelY = "TreePositionY_" + std::to_string(i);
					ImGui::InputFloat((labelY.c_str()), &TreeData_[i].position_.y);

					std::string labelZ = "TreePositionZ_" + std::to_string(i);
					ImGui::InputFloat((labelZ.c_str()), &TreeData_[i].position_.z);
				}
			...
			if (ImGui::TreeNode("TreeRotate"))
			{
				for (int i = 0; i < TreeData_.size(); i++)
				{
					...
					ImGui::InputFloat((labelX.c_str()), &TreeData_[i].rotate_.x);

					std::string labelY = "TreeRotateY_" + std::to_string(i);
					ImGui::InputFloat((labelY.c_str()), &TreeData_[i].rotate_.y);

					std::string labelZ = "TreeRotateZ_" + std::to_string(i);
					ImGui::InputFloat((labelZ.c_str()), &TreeData_[i].rotate_.z);
				}
			...
			if (ImGui::TreeNode("TreeScale"))
			{
				for (int i = 0; i < TreeData_.size(); i++)
				{
					...
					ImGui::InputFloat((labelX.c_str()), &TreeData_[i].scale_.x);

					std::string labelY = "TreeScaleY_" + std::to_string(i);
					ImGui::InputFloat((labelY.c_str()), &TreeData_[i].scale_.y);

					std::string labelZ = "TreeScaleZ_" + std::to_string(i);
					ImGui::InputFloat((labelZ.c_str()), &TreeData_[i].scale_.z);
				}
		...
		if (ImGui::TreeNode("Logs"))
		{
			if (ImGui::TreeNode("LogsPosition"))
			{
				for (int i = 0; i < LogsData_.size(); i++)
				{
					...
					ImGui::InputFloat((labelX.c_str()), &LogsData_[i].position_.x);

					std::string labelY = "LogsPositionY_" + std::to_string(i);
					ImGui::InputFloat((labelY.c_str()), &LogsData_[i].position_.y);

					std::string labelZ = "LogsPositionZ_" + std::to_string(i);
					ImGui::InputFloat((labelZ.c_str()), &LogsData_[i].position_.z);
				}
			...
			if (ImGui::TreeNode("LogsRotate"))
			{
				for (int i = 0; i < LogsData_.size(); i++)
				{
					...
					ImGui::InputFloat((labelX.c_str()), &LogsData_[i].rotate_.x);

					std::string labelY = "LogsRotateY_" + std::to_string(i);
					ImGui::InputFloat((labelY.c_str()), &LogsData_[i].rotate_.y);

					std::string labelZ = "LogsRotateZ_" + std::to_string(i);
					ImGui::InputFloat((labelZ.c_str()), &LogsData_[i].rotate_.z);
				}
			...
			if (ImGui::TreeNode("LogsScale"))
			{
				for (int i = 0; i < LogsData_.size(); i++)
				{
					...
					ImGui::InputFloat((labelX.c_str()), &LogsData_[i].scale_.x);

					std::string labelY = "LogsScaleY_" + std::to_string(i);
					ImGui::InputFloat((labelY.c_str()), &LogsData_[i].scale_.y);

					std::string labelZ = "LogsScaleZ_" + std::to_string(i);
					ImGui::InputFloat((labelZ.c_str()), &LogsData_[i].scale_.z);
				}
		...
		if (ImGui::TreeNode("Straw"))
		{
			if (ImGui::TreeNode("StrawPosition"))
			{
				for (int i = 0; i < StrawData_.size(); i++)
				{
					...
					ImGui::InputFloat((labelX.c_str()), &StrawData_[i].position_.x);

					std::string labelY = "StrawPositionY_" + std::to_string(i);
					ImGui::InputFloat((labelY.c_str()), &StrawData_[i].position_.y);

					std::string labelZ = "StrawPositionZ_" + std::to_string(i);
					ImGui::InputFloat((labelZ.c_str()), &StrawData_[i].position_.z);
				}
			...
			if (ImGui::TreeNode("StrawRotate"))
			{
				for (int i = 0; i < StrawData_.size(); i++)
				{
					...
					ImGui::InputFloat((labelX.c_str()), &StrawData_[i].rotate_.x);

					std::string labelY = "StrawRotateY_" + std::to_string(i);
					ImGui::InputFloat((labelY.c_str()), &StrawData_[i].rotate_.y);

					std::string labelZ = "StrawRotateZ_" + std::to_string(i);
					ImGui::InputFloat((labelZ.c_str()), &StrawData_[i].rotate_.z);
				}
			...
			if (ImGui::TreeNode("StrawScale"))
			{
				for (int i = 0; i < StrawData_.size(); i++)
				{
					...
					ImGui::InputFloat((labelX.c_str()), &StrawData_[i].scale_.x);

					std::string labelY = "StrawScaleY_" + std::to_string(i);
					ImGui::InputFloat((labelY.c_str()), &StrawData_[i].scale_.y);

					std::string labelZ = "StrawScaleZ_" + std::to_string(i);
					ImGui::InputFloat((labelZ.c_str()), &StrawData_[i].scale_.z);
				}
